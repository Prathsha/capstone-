...
const IBM_PORTFOLIO = [
  // ── Automation / Integration ─────────────────────────────────────────────
  {
    ...
    category: 'Messaging',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Jan 2027' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: true,  renewal: 'Jan 2027' },
  ...
  },
  {
    ...
    installs: {
      ...
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: true,  renewal: 'Mar 2027' },
      'SUNGARD DATA SYSTEMS':    { owned: false, renewal: null },
      'SELECT MEDICAL CORP':     { owned: false, renewal: null },
      'RICOH':                   { owned: false, renewal: null },
      'SAGENT M&C LLC':          { owned: false, renewal: null },
  ...
  {
    product: 'IBM Sterling B2B / ITX',
    category: 'Supply Chain / B2B',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Dec 2026' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: true,  renewal: 'Mar 2027' },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
      'SUNGARD DATA SYSTEMS':    { owned: false, renewal: null },
      'SELECT MEDICAL CORP':     { owned: false, renewal: null },
  ...
  {
    product: 'IBM WebSphere App Server',
    category: 'App Runtime',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Mar 2027' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
  ...
  },
  {
    ...
    installs: {
      ...
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: true,  renewal: 'Aug 2026' },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
      'SUNGARD DATA SYSTEMS':    { owned: false, renewal: null },
      'SELECT MEDICAL CORP':     { owned: false, renewal: null },
      'RICOH':                   { owned: false, renewal: null },
  ...
  },
  {
    ...
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Feb 2027' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
  ...
  {
    product: 'IBM DataStage',
    category: 'Data Integration',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Nov 2026' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: true,  renewal: 'Sep 2026' },
      'SUNGARD DATA SYSTEMS':    { owned: false, renewal: null },
      'SELECT MEDICAL CORP':     { owned: false, renewal: null },
      'RICOH':                   { owned: false, renewal: null },
      'SAGENT M&C LLC':          { owned: false, renewal: null },
  ...
  // ── Infrastructure ───────────────────────────────────────────────────────
  {
    product: 'IBM Tape / Disk Storage',
    category: 'Storage',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Oct 2026' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
  ...
  {
    product: 'IBM AIX (Power)',
    category: 'Infrastructure',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Jun 2027' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
      'SEI INVESTMENTS':         { owned: false, renewal: null },
      'INDEPENDENCE BLUECROSS':  { owned: false, renewal: null },
  ...
  {
    product: 'IBM z16 (Mainframe)',
    category: 'TXP / Mainframe',
    installs: {
      'QUEST DIAGNOSTICS':       { owned: true,  renewal: 'Mar 2027' },
      'THE LINCOLN NATIONAL':    { owned: false, renewal: null },
      'SIEMENS':                 { owned: false, renewal: null },
  ...
  // ── Other accounts' existing products ───────────────────────────────────
  {
...
const COMP_FOOTPRINT = [
  ...
  },
  {
    ...
    accounts: {
      'QUEST DIAGNOSTICS':      { present: true,  threat: 'High',   products: 'Looker / BigQuery — BI Consolidation displacement risk' },
      'THE LINCOLN NATIONAL':   { present: false, threat: null,     products: null },
